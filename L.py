...
def logo():
    time.sleep(0.1)
    os.system('echo -e "\n_______      _______        _____\n|  |  |      |_____| |        |\n|  |  |      |     | |_____ __|__                                                                                                                                 [MOHSIN ALI THE BRAND ] \n\n\n-----------------------------------------------\n\n\xe2\x9e\xa3 CODED BY  : MOHSIN ALI \n\xe2\x9e\xa3 MY PAGE  : MOHSIN TRICKER\n\xe2\x9e\xa3 Github   : https://github.com/MohSinTheLegend\n\xe2\x9e\xa3 Whatsapp :+994400385410 \n\n-----------------------------------------------" | lolcat -a -d 2 -s 50')
